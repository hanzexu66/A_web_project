        ...
        if (xhr.readyState == 4)
            if (xhr.status == 200) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    node12.className = "bought-table-mod__col3___263xB";
                    node13.className = "bought-table-mod__col3___263xB";
                    node14.className = "bought-table-mod__col3___263xB";
                    ...
                    var node2121 = document.createTextNode("3000");
                    var node2131 = document.createTextNode(b);
                    var node2141 = document.createTextNode(c);
